      ...
      <div class="content-wrapper" style="overflow-y: auto">
        ...
        <div class="content-header">
          <div class="container-fluid">
            <div class="row mb-2">
              <div class="col-sm-6">
                <h1 class="m-0">VaidikWall Videos</h1>
              </div>
              <!-- /.col -->
              <div class="col-sm-6">
...
while($row=mysqli_fetch_array($query)){
  ...
  <td>'.$row['time'].'</td>
  <td>
      <a href="/img-id"> <video width="320" height="240" controls>
  ...
  <td>
      <a href="edit_videos.php?image_id='.$row['id'].'"><i class="fas fa-edit"></i></a>
      <a href="delete_videos.php?image_id='.$row['id'].'" class="text-danger"><i
