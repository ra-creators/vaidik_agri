    ...
    <div class="wrapper" style="height: 100vh; overflow-y: hidden">
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <a href="index3.html" class="brand-link">
                <img src="/admin-new/dist/img/AdminLTELogo.png" alt="AdminLTE Logo"
            ...
            <div class="sidebar">
               ...
               with font-awesome or any other icon font library -->
                        ...
                        <li class="nav-item">
                            <a href="/admin-new/contactus.html" class="nav-link">
        ...
        <div class="content-wrapper" style="overflow-y: auto">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0">VaidikWall blogs</h1>
                        </div>
                        <!-- /.col -->
                        <div class="col-sm-6">
            ...
            <div class="content">
                <div class="container-fluid">
                    <div class="row my-4">
                        ...
                        <h4 class="my-auto">add vaidakwall blog</h4>
                    </div>
                    <div class="row">
                        <div class="col-12">
                            <div class="card">
...
while($row=mysqli_fetch_array($query)){
  ...
  <td>'.$row['time'].'</td>
  <td>
    <a href="edit_articles.php?image_id='.$row['sl_no'].'"
      ><i class="fas fa-edit"></i
    ></a>
    <a href="delete_articles.php" class="text-danger"
