            ...
            <div class="row">
              <div class="col-12">
                <div class="card">
                  <div class="card-body">
                    <form
                      action="handle_edit_videos.php?image_id=<?php echo $ids; ?>"
                      method="POST"
                      enctype="multipart/form-data"
                      class="bootstrap-form-with-validation"
                    >
                      <h2 class="text-center">Add Vidoes</h2>
                      <div class="form-group mb-3">
                        <label class="form-label" for="text-input">Title</label
                        ><input
                          class="form-control"
                          type="text"
                          id="text-input-1"
