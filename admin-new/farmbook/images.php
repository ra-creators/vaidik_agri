            ...
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item dropdown">
                    <a class="nav-link" data-toggle="dropdown" href="#">
                        ...
                        <span class="badge badge-danger navbar-badge"><?php echo $num_row3; ?></span>
                    </a>
                    <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
                        <a href="#" class="dropdown-item">
                            <!-- Message Start -->
                            <div class="media">
                                <img src="/admin-new/dist/img/user1-128x128.jpg" alt="User Avatar"
                        ...
                        <a href="#" class="dropdown-item">
                            <!-- Message Start -->
                            <div class="media">
                                <img src="/admin-new/dist/img/user8-128x128.jpg" alt="User Avatar"
                        ...
                        <a href="#" class="dropdown-item">
                            <!-- Message Start -->
                            <div class="media">
                                <img src="/admin-new/dist/img/user3-128x128.jpg" alt="User Avatar"
                                    class="img-size-50 img-circle mr-3" />
                                <div class="media-body">
                                    <h3 class="dropdown-item-title">
                                        Nora Silvester
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item menu-open">
                                    ...
                                    <ul class="nav nav-treeview ml-2">
                                        ...
                                        <li class="nav-item">
                                            <a href="vaidakwall.php" class="nav-link">
                                                <i class="nav-icon fab fa-blogger-b"></i>
                                                <p>Vaidik Wall</p>
                                            </a>
                                        </li>
                                ...
                                <li class="nav-item menu-open">
                                    ...
                                    <ul class="nav nav-treeview ml-2">
                                        <li class="nav-item">
                                            <a href="add_videos.php" class="nav-link">
                                                <i class="nav-icon fa fa-plus-square"></i>
                                                <p>add Video</p>
                                            </a>
                                        </li>
        ...
        <div class="content-wrapper" style="overflow-y: auto">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0">VaidikWall Images</h1>
                        </div>
                        <!-- /.col -->
                        <div class="col-sm-6">
            ...
            <div class="content">
                <div class="container-fluid">
                    <div class="row my-4">
                        <a href="#" class="ml-auto mr-1 btn btn-success">+</a>
                        <h4 class="my-auto">add image</h4>
                    </div>
                    <div class="row">
                        <div class="col-12">
                            <div class="card">
...
while($row=mysqli_fetch_array($query)){
  ...
  <td>
     <img style="height: 15rem"
              src="'.$row['location'].'" alt="" />
     
  </td>
  <td>
      <a href="edit_image.php?image_id='.$catid.'"><i class="fas fa-edit"></i></a>
      <a href="delete_images.php?image_id='.$catid.'" class="btn btn-danger ml-2 "><i
...
<!-- Button trigger modal -->
    ...
    <!-- OPTIONAL SCRIPTS -->
    <script src="/admin-new/plugins/chart.js/Chart.min.js"></script>
