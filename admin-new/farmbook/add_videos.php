...
if(isset($_POST['upload']))
{
    ...
    $file_store = "../assets/upload/videos/".$file_name;

    $sql = "INSERT INTO videos ( `title`,`location`) VALUES ( '$title', '$file_store')";
    ...
    if(move_uploaded_file($file_tem_loc,$file_store)){
        ...
        <strong>Success!</strong> Video has been successfully uploaded.
