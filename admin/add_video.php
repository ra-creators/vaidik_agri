                ...
                <div class="row mh-100vh">
                    <div class="col-10 col-sm-8 col-md-6 col-lg-6 offset-1 offset-sm-2 offset-md-3 offset-lg-0 align-self-center d-lg-flex align-items-lg-center align-self-lg-stretch bg-white p-5 rounded rounded-lg-0 my-5 my-lg-0" id="login-block">
                        <div class="m-auto w-lg-75 w-xl-50">
                            <h2 class="text-info fw-light mb-5"><i class="fa fa-video-camera"></i>&nbsp;Add Videos</h2>
                            ...
                            <form action="add_video.php" method="POST" enctype="multipart/form-data">
                                <div class="form-group mb-3"><label class="form-label text-secondary">Title</label><input class="form-control" type="text" required=""  inputmode="text" name ="title"></div>
                                <div class="form-group mb-3"><label class="form-label" for="file-input">Select the video</label><input class="form-control" type="file" id="file-input" name="file"></div>
                                <button class="btn btn-info mt-2" type="submit" name="upload">Add Video</button>
                            </form>
