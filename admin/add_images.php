...
if(isset($_POST['upload']))
{
    ...
    $sql = "INSERT INTO images ( `author`,`location`) VALUES ( '$title', '$file_store')";
    ...
    if(move_uploaded_file($file_tem_loc,$file_store)){
        ...
        <strong>Success!</strong> Image has been successfully uploaded.
                        ...
                        <div class="col">
                            <section class="article-list">
                                <div class="container">
                                    ...
                                    <form action="add_images.php" method="POST" enctype="multipart/form-data" class="bootstrap-form-with-validation">
                                        ...
                                        <div class="form-group mb-3"><label class="form-label" for="file-input">Select the Image</label><input class="form-control" type="file" id="file-input" name="file"></div>
                                        <div class="form-group mb-3"><button class="btn btn-primary" type="submit" name="upload">Upload</button></div>
                                    </form>
