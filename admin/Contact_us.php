        ...
        <nav class="navbar navbar-dark align-items-start sidebar sidebar-dark accordion bg-gradient-primary p-0">
            <div class="container-fluid d-flex flex-column p-0"><a class="navbar-brand d-flex justify-content-center align-items-center sidebar-brand m-0" href="#">
                ...
                <ul class="navbar-nav text-light" id="accordionSidebar">
                    ...
                    <li class="nav-item"><a class="nav-link " href="blogs.php"><i class="fab fa-blogger" style="color: var(--bs-red);"></i><span>Blogs</span></a><a class="nav-link" href="images.php"><i class="far fa-images" style="color: var(--bs-red);background: var(--bs-yellow);"></i><span>Images</span></a><a class="nav-link active" href="Contact_us.php"><i class="material-icons" style="color: var(--bs-red);background: var(--bs-white);">contact_mail</i><span>Contact Us</span></a></li>
                    ...
                    <div class="row">
                        <div class="col">
                            <section class="article-list">
                                <div class="container" style="padding: 0px;"><div class="bootstrap_datatables">
