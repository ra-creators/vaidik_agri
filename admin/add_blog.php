...
if(isset($_POST['upload']))
{
    ...
    $sql = "INSERT INTO blogs ( `title`,`author`,`content`,`location`) VALUES ( '$title', '$author', '$content', '$file_store')";
    ...
    if(move_uploaded_file($file_tem_loc,$file_store)){
        ...
        <strong>Success!</strong> Blog has been successfully posted.
                        ...
                        <div class="col">
                            <section class="article-list">
                                <div class="container">
                                    ...
                                    <form action="add_blog.php" method="POST" enctype="multipart/form-data" class="bootstrap-form-with-validation">
                                        <h2 class="text-center">Add Blog</h2>
                                        <div class="form-group mb-3"><label class="form-label" for="text-input">Title of Blog</label><input class="form-control" type="text" id="text-input" name="title"></div>
                                        ...
                                        <div class="form-group mb-3"><label class="form-label" for="file-input">Blog Image</label><input class="form-control" type="file" id="file-input" name="file"></div>
