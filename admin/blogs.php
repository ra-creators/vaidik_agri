                    ...
                    <div class="row">
                        <div class="col">
                            <section class="article-list">
                                <div class="container">
                                    <div class="intro">
                                        <h2 class="text-center">Blogs/Articles</h2>
                                    </div>
                                    <div class="row articles">
                                        <div class="col-sm-6 col-md-4 item"><a href="add_blog.php"><img class="img-fluid" src="assets/img/blogging.png" style="width: 150px;height: 150px;"></a>
                                            <h3 class="name">Add Blogs</h3><a href="add_blog.php" class="btn btn-secondary btn-icon-split" role="button"><span class="text-white-50 icon"><i class="fas fa-arrow-right"></i></span><span class="text-white text">Add Blogs</span></a><a class="action" href="#"></a>
                                        </div>
                                        <div class="col-sm-6 col-md-4 item"><a href="#"><img class="img-fluid" src="assets/img/blog.png" style="width: 150px;"></a>
                                            <h3 class="name">Blogs Details</h3><a class="btn btn-secondary btn-icon-split" role="button"><span class="text-white-50 icon"><i class="fas fa-arrow-right"></i></span><span class="text-white text">Blogs Details</span></a><a class="action" href="#"></a>
                                        </div>
                                    </div>
                                </div>
                            </section>
