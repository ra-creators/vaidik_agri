...
if(isset($_POST['upload']))
{
    ...
    $file_store = "assets/upload/articles/".$file_name;

    $sqlll = "INSERT INTO articles ( `title`,`author`,`content`,`location`) VALUES ( '$title', '$author', '$content', '$file_store')";
    ...
    if(move_uploaded_file($file_tem_loc,$file_store)){
        ...
        <strong>Success!</strong> Article has been successfully posted.
                        ...
                        <div class="col">
                            <section class="article-list">
                                <div class="container">
                                    ...
                                    <form action="add_articles.php" method="POST" enctype="multipart/form-data" class="bootstrap-form-with-validation">
                                        <h2 class="text-center">Add Article To Engineering Blog</h2>
                                        <div class="form-group mb-3"><label class="form-label" for="text-input">Title of article</label><input class="form-control" type="text" id="text-input" name="title"></div>
                                        <div class="form-group mb-3"><label class="form-label" for="text-input">Author</label><input class="form-control" type="text" id="text-input-1" name="author"></div>
                                        <div class="form-group mb-3"><label class="form-label" for="textarea-input">Contents</label><textarea class="form-control" id="textarea-input" name="content" rows="10"></textarea></div>
                                        <div class="form-group mb-3">
                                            <div class="input-group"></div>
                                        </div>
                                        <div class="form-group mb-3"><label class="form-label" for="file-input">Article Image</label><input class="form-control" type="file" id="file-input" name="file"></div>
                                        <div class="form-group mb-3"><button class="btn btn-primary" type="submit" name="upload">Post</button></div>
                                    </form>
