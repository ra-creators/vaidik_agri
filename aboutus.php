...
<html lang="en">
  ...
  <body>
          ...
          <div class="offcanvas-body">
            <ul class="navbar-nav">
              <li class="nav-item mx-3 fw-bolder">
                <a class="nav-link h5 active" aria-current="page" href="index.php"
                  >Home</a
                >
              </li>
      ...
      <div class="row g-5 px-3 mx-3 justify-content-center">
        <div class="col-lg-4 col-sm-12 my-5">
          <div class="card border-0 bg-transparent">
            <img
              src="assets/img/Agriculture-Leader.png"
              class="feature-img card-img border-0 rounded-3 h-auto feature-img"
        ...
        <div class="col-lg-4 col-sm-12 my-5">
          <div class="card border-0 bg-transparent">
            <img
              src="assets/img/Quality-Standard.png"
              class="feature-img card-img border-0 rounded-3 h-auto feature-img"
        ...
        <div class="col-lg-4 col-sm-12 my-5">
          <div class="card border-0 bg-transparent">
            <img
              src="assets/img/Organic-Services.png"
              class="feature-img card-img border-0 rounded-3 h-auto feature-img"
    ...
    <section id="growth" class="p-5">
      <div class="row">
        <div class="col-md-6">
          ...
          <div class="row">
            <h2 class="">BRINGING GROWTH TO AGRICULTURE</h2>
          </div>
          <div class="row">
            <p>
              We provide leading solutions to agricultural and agro-industrial
              production through world-class products and services, always
              committed to meeting the needs and expectations.
              <br />
          ...
          <div class="row">
            <div class="col-sm-6">
              <div class="card" style="width: 18rem">
                <img
                  src="assets/img/aboutus/security-svgrepo-com 1.png"
                  class="card-img-top p-3"
                  alt="Passionate"
                />
                <div class="card-body">
                  <h5 class="card-title fw-bold">We are Passionate</h5>
                  <p class="card-text">
        ...
        <div class="col-md-6 text-center">
          <img
            src="assets/img/aboutus/Rectangle 136.png"
            alt=""
            class="img-fluid"
          />
        </div>
    ...
    <section id="expert" class="p-5 d-flex flex-column align-items-end">
      <div
        id="bottom-carousel"
      ...
      >
        <div class="carousel-indicators">
          <button
            type="button"
            data-bs-target="#bottom-carousel"
            data-bs-slide-to="0"
            class="active"
            aria-current="true"
            aria-label="Slide 1"
        ...
        <div class="carousel-inner">
          <div class="carousel-item active">
            <div class="row g-2 mt-auto">
              <div class="col-md-4">
                <div class="row"><h5>MEET THE TEAM</h5></div>
                <div class="row">
                  <h2 class="fw-bold">Expert Farmers</h2>
                </div>
                <div class="row">
                  <p>
              ...
              <div class="col-md-4">
                <img
                  src="assets/img/aboutus/Rectangle 131.png"
                  alt=""
                  class="img-fluid"
                />
              </div>
      ...
      <div class="decorators">
        <img src="assets/img/aboutus/Group 7.png" alt="" />
      </div>
    </section>
