  ...
  <section id="navbar-slider">
    ...
    <div id="carouselIndicators" class="carousel slide" data-bs-ride="carousel">
      <div class="carousel-indicators">
        ...
        <button type="button" data-bs-target="#carouselIndicators" data-bs-slide-to="1" class=""
          aria-label="Slide 2"></button>
        <button type="button" data-bs-target="#carouselIndicators" data-bs-slide-to="2" class=""
            ...
            <div class="row g-5 p-3 m-3 justify-content-center text-light">
              <div class="col-lg-7 text-lg-start col-sm-12 text-sm-center">
                ...
                <div class="d-grid col-lg-5 col-sm-12">
                  <a href="#" role="button"
                    class="py-3 btn btn-lg rounded-pill btn-outline-warning text-warning bg-transparent">
                    <h3>Learn More</h3>
                  </a>
                </div>
              </div>
      ...
      <div class="row g-5 px-3 mx-3 justify-content-center">
        ...
        <div class="col-lg-4 col-sm-12 my-5">
          <div class="card border-0 bg-transparent">
            <img src="assets/img/Agriculture-Leader.png"
              class="feature-img card-img border-0 rounded-3 h-auto feature-img" alt="Agriculture Leader">
        ...
        <div class="col-lg-4 col-sm-12 my-5">
          <div class="card border-0 bg-transparent">
            <img src="assets/img/Quality-Standard.png"
              class="feature-img card-img border-0 rounded-3 h-auto feature-img" alt="Quality Standard">
            <div class="feature-fab card-footer text-center rounded-3 bg-peach mx-lg-5">
        ...
        <div class="col-lg-4 col-sm-12 my-5">
          <div class="card border-0 bg-transparent">
            <img src="assets/img/Organic-Services.png"
              class="feature-img card-img border-0 rounded-3 h-auto feature-img" alt="Organic Services">
            <div class="feature-fab card-footer text-center rounded-3 bg-peach mx-lg-5">
...
There are many variations of passages of lorem ipsum available but the majority have suffered alteration in some form by injected humor or random word which don't look even.
        ...
        <div
          class="d-grid offset-xl-0 col-xxl-6 offset- col-xl-8 offset-lg-4 col-lg-4 offset-md-3 col-md-6 col-sm-12 text-xl-start text-sm-center">
      ...
      <div class="row justify-content-center text-center">
        ...
        <div class="row justify-content-center px-3 mx-3 g-5">
          ...
          <div class="col-xl-3 col-lg-5 col-md-6 col-sm-12">
            <div class="card">
              <img src="assets/img/service-1.png" class="card-img-top img-fluid services-img"
      ...
      <div class="row justify-content-center text-center">
        ...
        <div class="row justify-content-center">
          ...
          <div id="carouselIndicators2" class="carousel carousel-dark slide" data-bs-ride="carousel">
            <div class="carousel-indicators">
              <button type="button" data-bs-target="#carouselIndicators2" data-bs-slide-to="0" class="active"
                aria-current="true" aria-label="Slide 1"></button>
              <button type="button" data-bs-target="#carouselIndicators2" data-bs-slide-to="1"
                aria-label="Slide 2"></button>
              <button type="button" data-bs-target="#carouselIndicators2" data-bs-slide-to="2"
                aria-label="Slide 3"></button>
            </div>
            <div class="carousel-inner">
          ...
          <div class="carousel-inner">
              ...
              <div class="carousel-item active">
                <div class="row justify-content-center text-center p-3 m-3">
                  <div class="col-lg-8 col-sm-10">
                    <video class="w-100" onclick="this.paused ? this.play() : this.pause();" muted
                      poster="assets/img/client-thumbnail.png">
  ...
  ?>
        ...
        <div class="col-lg-4 col-md-8 col-sm-12">
          <div class="card">
            ...
            <div
              class="col-lg-3 col-md-3 col-sm-3 rounded-circle bg-warning border border-white border-5 blog-icon text-center">
      ...
      <div id="leaves-2">
        <div class="row justify-content-center m-3 p-3 g-3">
          <div class="col-5">
            ...
            <img src="assets/img/contact-farmer.png" class="img-fluid w-50 position-absolute contact-img"
              alt="Contact">
          </div>
            ...
            <div class="contact-form p-3 m-3 py-5 my-5">
              ...
              <form action="index.php" method="post">
                ...
                <div class="mb-3 px-3">
                  ...
                  <input type="text" class="form-control form-control-lg rounded-border p-3" id="name" name="name"
                    placeholder="Enter your full name">
                </div>
                <div class="mb-3 px-3">
                  <label for="email" class="h3 form-label">Email</label>
                  <input type="email" class="form-control form-control-lg rounded-border p-3" id="email" name="email"
                    placeholder="Enter your email address">
                </div>
                <div class="mb-3 px-3">
                  <label for="phone" class="h3 form-label">Phone Number</label>
                  <input type="text" class="form-control form-control-lg rounded-border p-3" id="phone" name="phone"
                    placeholder="Enter your phone number">
                </div>
                <div class="mb-3 px-3">
                  <label for="message" class="h3 form-label">Message</label>
                  <textarea class="form-control form-control-lg rounded-border p-3" id="message" name="message"
